...
const SignUp = () => {
  ...
  return (
    <>
      <div className="container w-screen min-h-screen flex items-center justify-center pl-[100px]">
        <div className="left w-[35%]">
          ...
          <form onSubmit={submitForm} className='w-full mt-[60px]' action="">
            ...
            <p className='text-[gray]'>Already have an account <Link to="/login" className='text-[#1a404e]'>login</Link></p>
